...
class SGECluster(Cluster):
    ...
    def submit(self, prog, argument=[], cwd=None, stdout=None, stderr=None, log=None,
        ...
        #print "!=== inteded change ",text.replace('/local-scratch/melu/genproductions/bin/MadGraph5_aMCatNLO/nfs','')
        #text = text.replace('/local-scratch/melu/genproductions/bin/MadGraph5_aMCatNLO/nfs','')
        homePath = os.getenv("HOME")
        if homePath:
