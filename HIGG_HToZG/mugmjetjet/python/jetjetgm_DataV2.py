...
class jetjetgm_DataV2(object):
    ...
    def _assign(self, Tree):
        ...
        #------------------------------------------------------------ MASS
        self.lepton1_m      .append(Tree.leptonOneP4.M())            
        self.lepton2_m      .append(Tree.leptonTwoP4.M())            
        ...
        self.lepton1_pt     .append(Tree.leptonOneP4.Pt())
        self.lepton2_pt     .append(Tree.leptonTwoP4.Pt())
        ...
        self.lepton1_eta    .append(Tree.leptonOneP4.Eta())
        self.lepton2_eta    .append(Tree.leptonTwoP4.Eta())
        ...
        self.lepton1_phi    .append(Tree.leptonOneP4.Phi())
        self.lepton2_phi    .append(Tree.leptonTwoP4.Phi())
        ...
        #------------------------------------------------------------ DELTAS
        #------------------------------------------------------------ DELTA ETA 
        self.MuGm_D_eta     .append(self.lepton1_eta[-1]  - self.photon_eta[-1]  )
        ...
        self.Jet1Mu_D_eta   .append(self.jet1_eta  [-1]  - self.lepton1_eta[-1]  )
        self.Jet2Mu_D_eta   .append(self.jet2_eta  [-1]  - self.lepton1_eta[-1]  )            
        #------------------------------------------------------------
        #------------------------------------------------------------ DELTA PHI 
        self.MuGm_D_phi     .append(delta_phi(self.lepton1_phi[-1]  , self.photon_phi[-1]  ))
        ...
        self.Jet1Mu_D_phi   .append(delta_phi(self.jet1_phi  [-1]  , self.lepton1_phi[-1]  ))
        self.Jet2Mu_D_phi   .append(delta_phi(self.jet2_phi  [-1]  , self.lepton1_phi[-1]  ))            
        #------------------------------------------------------------
        #------------------------------------------------------------ DELTA R                
        ...
        #--------------------------------------------    MORE ADVANCED  -------------------------------
        #----------------------------------------------------------------------------------------------
        self.dijetGm_D_eta  .append(self.dijet_eta  [-1]  - self.photon_eta  [-1]  )
        self.dijetGm_D_phi  .append(delta_phi(self.dijet_phi  [-1]  , self.photon_phi  [-1]  ))
        self.dijetGm_D_R    .append(np.sqrt(self.dijetGm_D_phi [-1]  **2 + self.dijetGm_D_eta [-1]  **2))
    ...
    def __add__(self,other):
        ...
        #------------------------------------------------------------ MASS        
        Other.lepton1_m     = self.lepton1_m + other.lepton1_m
        Other.lepton2_m     = self.lepton2_m + other.lepton2_m
        ...
        #------------------------------------------------------------ PT
        Other.lepton1_pt    = self.lepton1_pt + other.lepton1_pt
        Other.lepton2_pt    = self.lepton2_pt + other.lepton2_pt
        ...
        #------------------------------------------------------------ ETA
        Other.lepton1_eta   = self.lepton1_eta + other.lepton1_eta
        Other.lepton2_eta   = self.lepton2_eta + other.lepton2_eta
        ...
        #------------------------------------------------------------ PHI
        Other.lepton1_phi   = self.lepton1_phi  + other.lepton1_phi
        Other.lepton2_phi   = self.lepton2_phi  + other.lepton2_phi
...
#        if condition == True:
    ...
    def Hist(self, var = 'm2', part = ''):
        ...
        if   var == 'mlep2':
            ...
            if   part == 'lepton1': 
                data = self.lepton1_pt
            elif part == 'lepton2': 
                data = self.lepton2_pt                
            elif part == 'gm'  : 
                data = self.photon_pt
            elif part == 'jet1': 
                data = self.jet1_pt
            ...
            if   part == 'lepton1': 
                data = self.lepton1_eta
            elif part == 'lepton2': 
                data = self.lepton2_eta
            elif part == 'gm'  : 
            ...
            if   part == 'lepton1': 
                data = self.lepton1_phi
            elif part == 'lepton2': 
                data = self.lepton2_phi                
            elif part == 'gm'  : 
        ...
        hist = np.histogram(np.array(data)[self.cuts[:len(data)]],
...
class jetjetgm_Topology():
    def __init__(self):
        ...
        self.__xsec["WplusH"]      = 1.362*(2/3)  
        self.__xsec["WminusH"]     = 1.362*(1/3) 
